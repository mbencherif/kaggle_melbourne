% feature_CSP() -  Feature extraction by CSP
%
% Usage:
%    >> feature_CSP(EEGDATA,LABELS)
%
% Inputs:
%   EEGData         - An 3-dimension matrix m*n*k  m: electrod or channels
%                   n:time serial k: trial number
% Outputs:  
%   EEGFea          - Feature of EEGData , 2-dimension matrix rows:features
%                   cols : sample trial
%                     
